		...
		<section class="container formulario">
			...
			<div class="columns">
				<div class="column">
					...
					<input type="text" name="creditos_act_arren" class="input" />
				</div>
				<div class="column">
					<label class="label">Numero creditos activos factoraje: </label>
					<input type="text" name="creditos_act_factorare" class="input" />
				</div>
				<div class="column">
					<label class="label">Numero creditos activos revolventes: </label>
					<input type="text" name="creditos_act_revolventes" class="input" />
				</div>
				<div class="column">
					<label class="label">Numero creditos activos simples: </label>
					<input type="text" name="creditos_act_simples" class="input" />
				</div>
			</div>
			...
			<div class="columns">
				<div class="column">
					...
					<input type="text" name="saldo_act_arren" class="input" />
				</div>
				<div class="column">
					<label class="label">Saldo original creditos activos factoraje: </label>
					<input type="text" name="saldo_act_factorare" class="input" />
				</div>
				<div class="column">
					<label class="label">Saldo original creditos activos revolventes: </label>
					<input type="text" name="saldo_act_revolventes" class="input" />
				</div>
				<div class="column">
					<label class="label">Saldo original creditos activos simples: </label>
					<input type="text" name="saldo_act_simples" class="input" />
				</div>
			</div>
			...
			<div class="columns">
				<div class="column">
					...
					<input type="text" name="saldo_vigente_act_arren" class="input" />
				</div>
				<div class="column">
					<label class="label">Saldo vigente creditos activos factoraje: </label>
					<input type="text" name="saldo_vigente_act_factorare" class="input" />
				</div>
				<div class="column">
					<label class="label">Saldo vigente creditos activos revolventes: </label>
					<input type="text" name="saldo_vigente_act_revolventes" class="input" />
				</div>
				<div class="column">
					<label class="label">Saldo vigente creditos activos simples: </label>
					<input type="text" name="saldo_vigente_act_simples" class="input" />
				</div>
			</div>
